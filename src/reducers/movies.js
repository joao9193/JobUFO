...
export function getAllPopularMoviesFun(state = getAllPopularMovies, actions) {
  switch (actions.type) {
    ...
    case REQUEST_POPULAR_MOVIES_SUCCESS:
      ...
      break;
    case REQUEST_POPULAR_MOVIES_FAIL:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: false,
        fetchingFail: true,
      ...
      break;
    case REQUEST_POPULAR_MOVIES_COMPLETED:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: false,
        fetchingFail: false,
...
export function getMovieDetailsFun(state = getMovieDetails, actions) {
  switch (actions.type) {
    ...
    case REQUEST_MOVIE_DETAILS_FAIL:
      ...
      break;
    case REQUEST_MOVIE_DETAILS_COMPLETED:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: false,
        fetchingFail: false,
...
export function getMovieRecommendationsFun(state = getMovieRecommendations, actions) {
  switch (actions.type) {
    case REQUEST_MOVIE_RECOMMENDATION:
      return Object.assign({}, state, {
        fetchingStarted: true,
        fetchingSuccess: false,
        fetchingFail: false,
      ...
      break;
    case REQUEST_MOVIE_RECOMMENDATION_SUCCESS:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: true,
        fetchingFail: false,
      ...
      break;
    case REQUEST_MOVIE_RECOMMENDATION_FAIL:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: false,
        fetchingFail: true,
      ...
      break;
    case REQUEST_MOVIE_RECOMMENDATION_COMPLTED:
      return Object.assign({}, state, {
        fetchingStarted: false,
        fetchingSuccess: false,
        fetchingFail: false,
...
export function listMoviesFavouritesFun(state = listMoviesFavourites, actions) {
  switch (actions.type) {
    case REQUEST_LIST_MOVIE_FAVOURITES:
      return Object.assign({}, state, {
        fetchingStarted: true,
        fetchingSuccess: false,
        fetchingFail: false,
...
export function addMoviesFavouritesFun(state = addToMoviesFavourites, actions) {
  switch (actions.type) {
    case REQUEST_ADD_MOVIE_FAVOURITES:
      return Object.assign({}, state, {
        fetchingStarted: true,
        fetchingSuccess: false,
        fetchingFail: false,
...
export function removeMovieFromFavouritesFun(state = removeMoviesFromFavourites, actions) {
  switch (actions.type) {
    case REQUEST_REMOVE_MOVIE_FAVOURITES:
      return Object.assign({}, state, {
        fetchingStarted: true,
        fetchingSuccess: false,
        fetchingFail: false,
